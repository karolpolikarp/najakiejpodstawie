...
export class ELITools {
  ...
  private ACT_CODES: Record<string, { publisher: string; year: number; position: number; title: string }> = {
    ...
    'kro': { publisher: 'DU', year: 1964, position: 59, title: 'Kodeks rodzinny i opiekuńczy' },
    'kodeks rodzinny i opiekuńczy': { publisher: 'DU', year: 1964, position: 59, title: 'Kodeks rodzinny i opiekuńczy' },
