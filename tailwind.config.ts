...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'gradient-main': 'linear-gradient(to bottom, hsl(var(--gradient-start)), hsl(var(--gradient-end)))',
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        'soft-xl': '0 20px 60px -15px rgba(0, 0, 0, 0.15), 0 8px 20px -5px rgba(0, 0, 0, 0.08)',
